...
impl Agentreplay {
        ...
        F: FnOnce(&mut PromptTemplate),
    {
        ...
        let template = templates
            .get_mut(&id)
            .ok_or_else(|| AgentreplayError::NotFound(format!("Template {} not found", id)))?;
        ...
        F: FnOnce(&mut Experiment),
    {
        ...
        let experiment = experiments
            .get_mut(&id)
            .ok_or_else(|| AgentreplayError::NotFound(format!("Experiment {} not found", id)))?;
        ...
        F: FnOnce(&mut BudgetAlert),
    {
        ...
        let alert = alerts
            .get_mut(&id)
            .ok_or_else(|| AgentreplayError::NotFound(format!("Alert {} not found", id)))?;
