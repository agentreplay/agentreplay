    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          {error && (
            <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-500 rounded text-red-700 dark:text-red-300">
              Error: {error}
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              {attributes.prompt && (
                <div className="space-y-2">
                  ...
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-500/30 rounded-lg">
              ...
              {attributes.response && (
                <div className="space-y-2">
                  ...
                  <div className="p-4 bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-500/30 rounded-lg">
                    <pre className="text-sm text-foreground whitespace-pre-wrap font-sans">
                      {attributes.response}
                    </pre>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {Object.entries(attributes)
                    ...
                    .map(([key, value]) => (
                      <div
                        key={key}
                        className="p-3 bg-secondary/50 border border-border rounded"
                      >
              ...
              <details className="mt-4">
                ...
                <pre className="mt-2 p-4 bg-card border border-border rounded text-xs text-muted-foreground overflow-x-auto">
