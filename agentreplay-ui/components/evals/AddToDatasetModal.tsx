...
import { agentreplayClient, EvalDataset, EvalExample } from '../../src/lib/agentreplay-api';
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (createMode) {
                ...
                const newDataset = await agentreplayClient.createDataset(newDatasetName.trim());
            ...
            await agentreplayClient.addExamples(targetDatasetId, examples);
