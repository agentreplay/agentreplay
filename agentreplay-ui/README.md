...
- Request rate: `rate(agentreplay_llm_requests_total[5m])`
- Latency: `histogram_quantile(0.95, rate(agentreplay_llm_latency_seconds_bucket[5m]))`
- Costs: `increase(agentreplay_llm_cost_total[1h])`
