      ...
      <header className="flex flex-col gap-5 pt-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold tracking-tight" style={{ color: '#111827' }}>{currentProject?.name || 'Traces'}</h1>
              <p className="text-xs" style={{ color: '#9ca3af' }}>Observability · Traces</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Button
