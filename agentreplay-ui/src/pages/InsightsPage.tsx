...
import { agentreplayClient, type InsightsSummary, type InsightView, type InsightsQuery } from '../lib/agentreplay-api';
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      const [summaryData, insightsData] = await Promise.all([
        agentreplayClient.getInsightsSummary(numericProjectId),
        agentreplayClient.getInsights({ ...filters, project_id: numericProjectId }),
      ]);
