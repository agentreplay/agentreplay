...
fn extract_input_from_edge_with_db(
    edge: &flowtrace_core::AgentFlowEdge,
    db: &flowtrace_query::Flowtrace,
) -> Option<String> {
...
fn extract_input_from_edge(_edge: &flowtrace_core::AgentFlowEdge) -> Option<String> {
...
fn extract_output_from_edge(_edge: &flowtrace_core::AgentFlowEdge) -> Option<String> {
    None
}

#[allow(dead_code)]
#[deprecated(note = "Use extract_context_from_edge_with_db for proper payload extraction")]
fn extract_context_from_edge(_edge: &flowtrace_core::AgentFlowEdge) -> Option<String> {
    None
}
