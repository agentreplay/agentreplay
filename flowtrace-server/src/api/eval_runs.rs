    ...
    if let Some(ref status_filter) = params.status {
        ...
        runs.retain(|r| {
            let run_status = match r.status {
                flowtrace_core::eval_dataset::RunStatus::Running => "running",
                flowtrace_core::eval_dataset::RunStatus::Completed => "completed",
                flowtrace_core::eval_dataset::RunStatus::Failed => "failed",
                flowtrace_core::eval_dataset::RunStatus::Stopped => "stopped",
            };
