...
impl ToolExecutor {
    ...
    async fn execute_mcp(
        &self,
        _server_uri: &str,
        _transport: &flowtrace_core::MCPTransport,
        _tool_name: &str,
    ...
    async fn execute_rest(
        &self,
        endpoint: &str,
        method: &flowtrace_core::HttpMethod,
        ...
        let mut request = match method {
            flowtrace_core::HttpMethod::GET => client.get(endpoint),
            flowtrace_core::HttpMethod::POST => client.post(endpoint),
            flowtrace_core::HttpMethod::PUT => client.put(endpoint),
            flowtrace_core::HttpMethod::DELETE => client.delete(endpoint),
            flowtrace_core::HttpMethod::PATCH => client.patch(endpoint),
        };
        ...
        if !matches!(method, flowtrace_core::HttpMethod::GET) {
    ...
    async fn execute_mock(
        &self,
        responses: &[flowtrace_core::MockResponse],
        arguments: serde_json::Value,
    ) -> Result<serde_json::Value, ToolExecutionError> {
