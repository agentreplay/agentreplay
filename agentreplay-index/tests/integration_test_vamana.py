...
"""
Integration test for Agentreplay Vamana Index with Product Quantization.
...
def test_with_real_embeddings():
    ...
    texts = [
        "Agentreplay is an observability platform for LLM applications",
    ...
    try:
        ...
        query = embeddings[0]  # "Agentreplay..."
...
def test_rust_integration():
    ...
    try:
        result = subprocess.run(
            ["cargo", "test", "-p", "agentreplay-index", "--lib", "vamana", "--", "--quiet"],
            cwd="/Users/sushanth/agentreplay",
            capture_output=True,
            text=True,
            timeout=120
        )
...
def main():
    print("="*60)
    print("Agentreplay Vamana + Product Quantization Integration Test")
    print("="*60)
