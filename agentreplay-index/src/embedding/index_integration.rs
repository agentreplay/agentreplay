...
//!
//! ```rust,ignore
//! use agentreplay_index::embedding::{EmbeddingIntegration, IntegrationConfig};
//!
...
use sochdb_index::product_quantization::PQCodebooks;
...
impl Default for IntegrationConfig {
    fn default() -> Self {
        Self {
            data_dir: PathBuf::from("agentreplay-data/embeddings"),
            dimension: 384,
...
impl EmbeddingIntegration {
    ...
    pub fn semantic_search(
        ...
        let results = hnsw
            ...
            .map_err(|e| IntegrationError::Index(e))?;
