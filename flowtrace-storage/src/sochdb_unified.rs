...
//! Unified SochDB Storage Layer for FlowTrace
//!
//! This module provides the primary storage backend for FlowTrace using SochDB.
...
pub fn serialize_edge(edge: &AgentFlowEdge) -> Result<Vec<u8>> {
    bincode::serialize(edge).map_err(|e| FlowtraceError::Serialization(e.to_string()))
}

/// Deserialize bytes to an AgentFlowEdge
pub fn deserialize_edge(data: &[u8]) -> Result<AgentFlowEdge> {
    bincode::deserialize(data).map_err(|e| FlowtraceError::Serialization(e.to_string()))
}
...
/// Configuration for FlowTrace storage
#[derive(Debug, Clone)]
pub struct FlowTraceStorageConfig {
    /// Data directory
...
impl Default for FlowTraceStorageConfig {
    fn default() -> Self {
        Self {
            data_dir: PathBuf::from("./flowtrace_data"),
            enable_wal: true,
...
impl MetricsBucket {
    ...
    pub fn deserialize(data: &[u8]) -> Result<Self> {
        if data.len() < 64 {
            return Err(FlowtraceError::Serialization("Metrics bucket too short".into()));
        }
        Ok(Self {
...
/// Main storage interface for FlowTrace using SochDB
/// 
/// ## Features
/// 
...
pub struct FlowTraceStorage {
    /// SochDB connection
    connection: Arc<Connection>,
    /// Configuration
    config: FlowTraceStorageConfig,
...
impl FlowTraceStorage {
    /// Open storage at the given path
    pub fn open<P: AsRef<Path>>(path: P) -> Result<Self> {
        let config = FlowTraceStorageConfig {
    ...
    pub fn open_with_config(config: FlowTraceStorageConfig) -> Result<Self> {
        info!("Opening FlowTrace storage at {:?}", config.data_dir);
        
        // Create data directory if needed
        std::fs::create_dir_all(&config.data_dir)?;

        // ============================================================================
        // OPTIMIZATION: Configure SochDB for Flowtrace's trace ingestion workload
        // 
        // Flowtrace workload characteristics:
        ...
        // Override with Flowtrace-specific settings
        ...
        let connection = Connection::open_with_config(&config.data_dir, db_config)
            .map_err(|e| FlowtraceError::Internal(format!("Failed to open SochDB: {}", e)))?;
        ...
        info!(
            ...
            "FlowTrace storage opened successfully with optimizations"
        );
        Ok(storage)
    }
    ...
    fn load_initial_metrics(&self) -> Result<()> {
        ...
        let results = self.connection.scan(prefix)
            .map_err(|e| FlowtraceError::Internal(format!("Failed to scan metrics: {}", e)))?;
    ...
    pub fn put_durable(&self, edge: AgentFlowEdge) -> Result<()> {
        ...
        let _ = self.connection.commit()
            .map_err(|e| FlowtraceError::Internal(format!("SochDB commit failed: {}", e)))?;
    ...
    fn put_internal(&self, edge: AgentFlowEdge) -> Result<()> {
        ...
        self.connection.put(&key, &data)
            .map_err(|e| FlowtraceError::Internal(format!("SochDB put failed: {}", e)))?;
        ...
        if self.columnar_edges_enabled {
            ...
            self.connection.put(&columnar_key, packed_row.as_bytes())
                .map_err(|e| FlowtraceError::Internal(format!("SochDB columnar put failed: {}", e)))?;
        }
        ...
        self.connection.put(&edge_idx_key, key.as_bytes())
            .map_err(|e| FlowtraceError::Internal(format!("SochDB edge index update failed: {}", e)))?;
        ...
        self.connection.put(&session_key, &[])
            .map_err(|e| FlowtraceError::Internal(format!("SochDB session index update failed: {}", e)))?;
        ...
        self.connection.put(&project_key, &[])
             .map_err(|e| FlowtraceError::Internal(format!("SochDB project index update failed: {}", e)))?;
        ...
        self.connection.put(&tenant_ts_key, &[])
            .map_err(|e| FlowtraceError::Internal(format!("SochDB tenant index update failed: {}", e)))?;
    ...
    pub fn get(&self, edge_id: u128) -> Result<Option<AgentFlowEdge>> {
        ...
        if let Some(primary_key_bytes) = self.connection.get(&edge_idx_key)
            .map_err(|e| FlowtraceError::Internal(format!("SochDB index get failed: {}", e)))? {
            
            let primary_key = String::from_utf8(primary_key_bytes)
                .map_err(|e| FlowtraceError::Internal(format!("Invalid key encoding: {}", e)))?;
            
            if let Some(data) = self.connection.get(&primary_key)
                .map_err(|e| FlowtraceError::Internal(format!("SochDB get failed: {}", e)))? {
                if data.is_empty() {
                    return Ok(None);
                }
        ...
        let results = self.connection.scan(&prefix)
            .map_err(|e| FlowtraceError::Internal(format!("SochDB scan failed: {}", e)))?;
        ...
        if let Some(key_bytes) = self.connection.get(&edge_idx_key)
            ...
            if let Some((stored_tenant_id, project_id, timestamp_us, _)) = decode_trace_key(&key) {
                if stored_tenant_id != tenant_id {
                    ...
                    return Err(FlowtraceError::NotFound(
                ...
                self.connection.delete(&key)
                    .map_err(|e| FlowtraceError::Internal(format!("SochDB delete failed: {}", e)))?;
    ...
    pub fn delete_payload(&self, edge_id: u128) -> Result<()> {
        ...
        self.connection.delete(&payload_key)
            .map_err(|e| FlowtraceError::Internal(format!("SochDB delete payload failed: {}", e)))?;
        let _ = self.connection.commit()
            .map_err(|e| FlowtraceError::Internal(format!("SochDB commit failed: {}", e)))?;
        Ok(())
    }
    ...
    pub fn put_payload(&self, edge_id: u128, data: &[u8]) -> Result<()> {
        ...
        self.connection.put(&key, data)
            .map_err(|e| FlowtraceError::Internal(format!("SochDB put payload failed: {}", e)))?;
    ...
    pub fn get_payload(&self, edge_id: u128) -> Result<Option<Vec<u8>>> {
        ...
        self.connection.get(&key)
            .map_err(|e| FlowtraceError::Internal(format!("SochDB get payload failed: {}", e)))
    }
    ...
    pub fn cache_query_result(
        ...
        self.connection.put(&cache_key, &cached_data)
            .map_err(|e| FlowtraceError::Internal(format!("Cache store failed: {}", e)))?;
    ...
    pub fn lookup_cached_query(
        ...
        if let Some(cached_data) = self.connection.get(&cache_key)
            .map_err(|e| FlowtraceError::Internal(format!("Cache lookup failed: {}", e)))? 
        {
    ...
    pub fn invalidate_cached_query(&self, query: &str, namespace: &str) -> Result<()> {
        ...
        self.connection.delete(&cache_key)
            .map_err(|e| FlowtraceError::Internal(format!("Cache invalidation failed: {}", e)))?;
    ...
    pub fn invalidate_cache_namespace(&self, namespace: &str) -> Result<u64> {
        ...
        let entries = self.connection.scan(&prefix)
            .map_err(|e| FlowtraceError::Internal(format!("Cache scan failed: {}", e)))?;
    ...
    pub fn flush_metrics(&self) -> Result<()> {
        ...
        for ((tenant_id, project_id, timestamp_us), bucket) in buckets {
            ...
            self.connection.put(&key, &bucket.serialize())
                .map_err(|e| FlowtraceError::Internal(format!("Metrics flush failed: {}", e)))?;
        }
    ...
    pub fn sync(&self) -> Result<()> {
        ...
        self.connection.fsync()
            .map_err(|e| FlowtraceError::Internal(format!("SochDB fsync failed: {}", e)))?;
        Ok(())
    }
    ...
    pub fn shutdown(&self) -> Result<()> {
        ...
        info!("Shutting down FlowTrace storage");
        ...
        info!("FlowTrace storage shutdown complete");
        Ok(())
    }
...
impl Drop for FlowTraceStorage {
    fn drop(&mut self) {
...
mod tests {
    use super::*;
    use flowtrace_core::{Environment, SpanType};
    ...
    fn test_storage_put_get() {
        ...
        let storage = FlowTraceStorage::open(tmp_dir.path()).unwrap();
