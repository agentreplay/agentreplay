...
pub struct ObservabilityConfig {
    ...
    // Flowtrace custom
    pub flowtrace_endpoint: Option<String>,
    ...
    pub fn from_env() -> Self {
        Self {
            ...
            otel_service_name: env::var("OTEL_SERVICE_NAME")
                .unwrap_or_else(|_| "flowtrace".to_string()),
            ...
            // Custom Flowtrace config
            flowtrace_endpoint: env::var("FLOWTRACE_ENDPOINT").ok(),

            enable_dual_export: env::var("FLOWTRACE_DUAL_EXPORT")
                .map(|v| v == "true")
                .unwrap_or(false),
        }
    }
...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.otel_service_name, "flowtrace");
