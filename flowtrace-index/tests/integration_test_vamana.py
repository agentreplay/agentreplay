...
"""
Integration test for Flowtrace Vamana Index with Product Quantization.
...
def test_with_real_embeddings():
    ...
    texts = [
        "Flowtrace is an observability platform for LLM applications",
...
def test_rust_integration():
    ...
    try:
        result = subprocess.run(
            ["cargo", "test", "-p", "flowtrace-index", "--lib", "vamana", "--", "--quiet"],
...
def main():
    print("="*60)
    print("Flowtrace Vamana + Product Quantization Integration Test")
    print("="*60)
