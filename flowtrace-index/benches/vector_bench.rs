...
//!
//! Run with: cargo bench -p flowtrace-index --bench vector_bench

use flowtrace_index::vector::{DistanceMetric, VectorIndex};
use flowtrace_index::vector_quantized::{Precision, QuantizedVector};
use flowtrace_index::vector_simd;
use ndarray::Array1;
...
fn main() {
    println!("Flowtrace Vector Index - CoreNN-Inspired Optimizations Benchmark");
    println!("================================================================");
