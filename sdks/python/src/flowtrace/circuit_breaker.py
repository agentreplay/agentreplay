...
"""Circuit Breaker pattern for Flowtrace backend resilience.

This module implements a circuit breaker to prevent cascading failures when
the Flowtrace backend is unavailable. The circuit breaker has three states:
...
Usage:
    >>> from flowtrace.circuit_breaker import CircuitBreaker, CircuitBreakerOpen
    >>> 
    ...
    ...     logger.warning("Flowtrace backend unavailable, dropping spans")
"""
...
# Global circuit breaker instance for the Flowtrace backend
