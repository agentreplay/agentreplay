...
Integrates with Flowtrace's zero-code instrumentation.
"""
...
class FlowtraceCallbackHandler(BaseCallbackHandler):
...
def get_flowtrace_callback() -> Optional[FlowtraceCallbackHandler]:
    """Get Flowtrace callback handler if OTEL is available."""
    if not OTEL_AVAILABLE:
        return None
    return FlowtraceCallbackHandler()
