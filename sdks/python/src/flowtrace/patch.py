...
Examples:
    >>> from flowtrace import patch_langgraph, patch_llamaindex, patch_crewai
    >>> 
    >>> # LangGraph
    >>> patch_langgraph()
...
def patch_langgraph(
    ...
    flowtrace_url: str = "http://localhost:8080",
    tenant_id: int = 1,
    project_id: int = 0,
) -> None:
    """Enable Flowtrace observability for LangGraph with one line of code.
    ...
    Args:
        ...
        flowtrace_url: Flowtrace server URL
        tenant_id: Your tenant ID
        project_id: Your project ID
    
    Example:
        >>> from flowtrace import patch_langgraph
        >>> patch_langgraph()
        >>> 
...
def patch_llamaindex(
    ...
    """Enable Flowtrace observability for LlamaIndex with one line of code.
    ...
    Example:
        >>> from flowtrace import patch_llamaindex
        >>> patch_llamaindex()
        >>> 
...
def patch_crewai(
    ...
    """Enable Flowtrace observability for CrewAI with one line of code.
    ...
    Example:
        >>> from flowtrace import patch_crewai
        >>> patch_crewai()
        >>> 
...
def patch_autogen(
    ...
    """Enable Flowtrace observability for AutoGen with one line of code.
    ...
    Example:
        >>> from flowtrace import patch_autogen
        >>> patch_autogen()
        >>> 
...
def patch_haystack(
    ...
    """Enable Flowtrace observability for Haystack with one line of code.
    ...
    Example:
        >>> from flowtrace import patch_haystack
        >>> patch_haystack()
        >>> 
...
def patch_dspy(
    ...
    """Enable Flowtrace observability for DSPy with one line of code.
    ...
    Example:
        >>> from flowtrace import patch_dspy
        >>> patch_dspy()
        >>> 
