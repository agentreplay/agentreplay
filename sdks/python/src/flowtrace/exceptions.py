...
"""Custom exceptions for Flowtrace client."""


class FlowtraceError(Exception):
    """Base exception for all Flowtrace client errors."""
    pass


class AuthenticationError(FlowtraceError):
    """Raised when authentication fails (401 Unauthorized)."""
    pass


class RateLimitError(FlowtraceError):
...
class ServerError(FlowtraceError):
...
class ValidationError(FlowtraceError):
...
class NotFoundError(FlowtraceError):
...
class NetworkError(FlowtraceError):
