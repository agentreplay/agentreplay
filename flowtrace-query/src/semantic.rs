...
//!
//! ```rust,ignore
//! use flowtrace_query::semantic::{SemanticSearchEngine, SemanticQuery, QueryFilters};
//!
...
/// Trait for embedding providers (abstraction over flowtrace-index)
...
/// Trait for storage (abstraction over flowtrace-storage)
