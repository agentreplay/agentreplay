...
"""
Flowtrace + LangGraph Example (Mocked)
...
flowtrace.init_otel_instrumentation(
    ...
    otlp_endpoint=os.getenv("FLOWTRACE_OTLP_ENDPOINT", "127.0.0.1:4317"),
...
def research_agent(state: AgentState):
    ...
    if state['iterations'] == 0:
        ...
        # we will just return the message but we'll create a dummy span using flowtrace manual instrumentation if needed,
