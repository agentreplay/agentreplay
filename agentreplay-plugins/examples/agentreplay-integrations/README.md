...
├── agentreplay-plugin.toml      # Bundle manifest
├── README.md
...
The `agentreplay-plugin.toml` uses schema version 2 with bundle configuration:
...
from = "claude/plugin"
to = "${home}/.claude/plugins/agentreplay"
strategy = "copy_dir"
overwrite = true
```
...
enabledPlugins = { agentreplay = true }
...
op = "add"
path = "/mcpServers/agentreplay"
value = { command = "agentreplay-mcp", args = ["--stdio"] }
```
