...
//! Agentreplay Plugin SDK for Rust
//!
//! This SDK provides types and macros for building Agentreplay plugins in Rust.
//! Plugins are compiled to WASM and loaded by the Agentreplay runtime.
//!
//! # Quick Start
//!
//! ```rust,ignore
