...
These functions allow plugins to interact with the Agentreplay runtime.
"""
...
class Host:
    ...
    These functions are implemented by the Agentreplay WASM runtime
    ...
    def log(level: LogLevel, message: str) -> None:
        """
        Log a message to the Agentreplay logs.
