...
Usage:
    python -m agentreplay_plugin.build my_plugin.py -o my_plugin.wasm
    
    # Or using the CLI:
    agentreplay-plugin-build my_plugin.py -o my_plugin.wasm
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Build Agentreplay Python plugin to WASM"
    )
    parser.add_argument(
        "source",
        type=Path,
    ...
    parser.add_argument(
        "--world",
        type=str,
        default="agentreplay-plugin",
        help="WIT world name (default: agentreplay-plugin)"
    )
