...
fn eval_trace_v1_schema_contract() {
    ...
    eval_trace.transcript = vec![
        agentreplay_core::TranscriptEventV1::Message {
            id: "m1".to_string(),
            role: "assistant".to_string(),
            content: vec![ContentPartV1::Text {
                text: "Hello".to_string(),
        ...
        agentreplay_core::TranscriptEventV1::ToolCall {
            id: "tc1".to_string(),
        ...
        agentreplay_core::TranscriptEventV1::ToolResult {
            id: "tr1".to_string(),
        ...
        agentreplay_core::TranscriptEventV1::SpanStart {
            span_id: "s1".to_string(),
            parent_span_id: None,
            span_type: "Root".to_string(),
            timestamp_us: 1,
        },
        agentreplay_core::TranscriptEventV1::SpanEnd {
            span_id: "s1".to_string(),
            timestamp_us: 5,
            duration_us: 4,
            status: "completed".to_string(),
