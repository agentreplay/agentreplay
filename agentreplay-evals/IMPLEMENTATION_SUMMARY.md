...
```rust
use agentreplay_evals::{EvaluatorRegistry, TraceContext};
...
```toml
# /home/user/agentreplay/Cargo.toml
[workspace]
members = [
    "agentreplay-core",
    "agentreplay-storage",
...
```rust
// agentreplay-server/src/api/evals.rs
use agentreplay_evals::{EvaluatorRegistry, TraceContext};
...
Create directory `agentreplay-evals/prompts/`:
...
Add to `agentreplay-server/src/api/evals.rs`:
