...
curl -X POST http://localhost:9600/api/v1/memory/retrieve \\
  ...
  // Step-by-step: 1) Ensure Flowtrace Desktop is running
  // 2) Build the bridge: cd flowtrace-claude-bridge && npm install && npm run build
  // 3) Add this config to your editor's MCP settings
  const mcpConfigExample = `{
  "mcpServers": {
    "flowtrace-memory": {
      "command": "node",
      "args": ["<path>/flowtrace-claude-bridge/dist/index.js"],
      "env": {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-surface border border-border rounded-xl p-6">
            ...
            <p className="text-xs text-textSecondary mb-4">
              Interact with memory while Flowtrace is running via HTTP API.
            </p>
            <div className="relative">
              <button
        ...
        <div className="bg-background rounded-lg p-6">
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <div className="text-center text-sm text-textSecondary">
              ...
              or <strong>Online Mode</strong> (REST/MCP) when Flowtrace is running. Embedding dimension depends on your model
