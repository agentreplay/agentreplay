...
const STORAGE_KEY = 'flowtrace.prompts';
...
const samplePrompts: PromptRecord[] = [
  {
    ...
    deployedVersion: 7,
    activeVersion: 9,
    owner: 'maya@flowtrace.ai',
    content: `You are Flowtrace Onboarding Agent.
...
<summary>
  ...
  },
  {
    ...
    deployedVersion: 12,
    activeVersion: 12,
    owner: 'evals@flowtrace.ai',
    content: `You are the strict grounding reviewer for Flowtrace.
