...
//! integrates tightly with Flowtrace's tracing system - memory events appear
...
//!
//! ```rust,ignore
//! use flowtrace_memory::{MemoryEngine, MemoryConfig, Observation};
//!
//! #[tokio::main]
