...
//!
//! Defines the structure of `flowtrace-plugin.toml` manifest files.
...
pub struct PluginMetadata {
    /// Unique plugin identifier (e.g., "flowtrace-hallucination-detector")
    pub id: String,
    ...
    /// Minimum Flowtrace version required
    #[serde(default = "default_min_flowtrace_version")]
    pub min_flowtrace_version: String,
...
fn default_min_flowtrace_version() -> String {
    "0.1.0".to_string()
}
...
impl PluginManifest {
    ...
    pub fn validate(&self) -> PluginResult<()> {
        ...
        // Validate min flowtrace version
        semver::Version::parse(&self.plugin.min_flowtrace_version)?;
...
"#;
    ...
    fn test_parse_bundle_manifest() {
        ...
        assert_eq!(manifest.plugin.id, "flowtrace-suite");
