...
//! Flowtrace Plugin System
//!
//! A sandboxed, versioned plugin system for extending Flowtrace with custom
...
//!
//! In addition to runtime plugins, Flowtrace supports "bundle" plugins that
...
//!
//! ```rust,ignore
//! use flowtrace_plugins::{PluginManager, PluginConfig};
//!
//! #[tokio::main]
//! async fn main() {
...
pub const MANIFEST_FILENAME: &str = "flowtrace-plugin.toml";
