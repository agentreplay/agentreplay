...
use flowtrace_evals::{EvalResult, Evaluator, EvaluatorMetadata, TraceContext};
    ...
    pub fn from_evaluator(evaluator: Arc<dyn Evaluator>) -> Self {
        ...
        let manifest = PluginManifest {
            ...
            plugin: crate::manifest::PluginMetadata {
                ...
                min_flowtrace_version: "0.1.0".to_string(),
...
impl Evaluator for BuiltinEvaluatorPlugin {
    ...
    async fn evaluate(
        &self,
        trace: &TraceContext,
    ) -> Result<EvalResult, flowtrace_evals::EvalError> {
...
impl Evaluator for JsonEvaluatorPlugin {
    ...
    async fn evaluate(
        ...
        for rule in &self.rules {
            ...
            metrics.insert(
                rule.metric.clone(),
                flowtrace_evals::MetricValue::Float(result),
            );
