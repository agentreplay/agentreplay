...
A Flowtrace plugin that evaluates the sentiment of LLM outputs.
...
```bash
# Build the plugin
flowtrace plugin build ./plugins/sentiment-evaluator

# Install the plugin
flowtrace plugin install ./plugins/sentiment-evaluator
```
...
Configure in your Flowtrace settings:
...
# Build to WASM
flowtrace-plugin-build evaluator.py -o sentiment_evaluator.wasm
```
