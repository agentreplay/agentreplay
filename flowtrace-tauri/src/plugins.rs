...
fn parse_install_scope(scope: &str) -> Result<flowtrace_plugins::manifest::InstallScope, String> {
    use flowtrace_plugins::manifest::InstallScope;
