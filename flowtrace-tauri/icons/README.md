# Flowtrace Desktop Icons

This directory contains the application icons for the Flowtrace Tauri desktop app.
...
- **`desktop_icon.svg`** - The master source file for all icons (512x512)
  ...
  - Represents the Flowtrace concept of tracking agent execution flows
