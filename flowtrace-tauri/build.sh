...
UI_DIR="$PROJECT_ROOT/flowtrace-ui"
TAURI_DIR="$SCRIPT_DIR"

echo "=========================================="
echo "Flowtrace Tauri Build Script"
echo "=========================================="
echo ""
...
if [ -d "$UI_DIR" ]; then
    ...
    rm -rf "$TAURI_DIR/flowtrace-ui/dist"
    mkdir -p "$TAURI_DIR/flowtrace-ui"
    cp -r dist "$TAURI_DIR/flowtrace-ui/"
...
case "$PLATFORM" in
    macos)
        echo "📦 Output files:"
        echo "   • App: $TAURI_DIR/target/release/bundle/macos/Flowtrace.app"
        echo "   • DMG: $TAURI_DIR/target/release/bundle/dmg/Flowtrace_*.dmg"
        ;;
    linux)
        echo "📦 Output files:"
