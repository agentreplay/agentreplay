...
/// # Example
/// ```
/// use flowtrace_evals::evaluators::causal_integrity::formulas::cosine_similarity;
///
/// let a = vec![1.0, 0.0];
/// let b = vec![0.0, 1.0];
...
/// # Example
/// ```
/// use flowtrace_evals::evaluators::causal_integrity::formulas::adherence_score;
///
...
/// # Example
/// ```
/// use flowtrace_evals::evaluators::causal_integrity::formulas::robustness_score;
///
...
/// # Example
/// ```
/// use flowtrace_evals::evaluators::causal_integrity::formulas::cip_score;
///
/// // Both high → high CIP
...
/// # Example
/// ```
/// use flowtrace_evals::evaluators::causal_integrity::formulas::compute_cip_metrics;
///
