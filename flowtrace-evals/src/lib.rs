...
//! # Flowtrace Evaluation Framework
//!
...
//!
//! ```rust,ignore
//! use flowtrace_evals::{Evaluator, TraceContext, EvaluatorRegistry};
...
pub use flowtrace_core::{EvalResultV1 as EvalResult, MetricValueV1 as MetricValue};
pub use comparator::{
...
pub struct TraceContext {
    ...
    pub edges: Vec<flowtrace_core::AgentFlowEdge>,
    ...
    pub eval_trace: Option<flowtrace_core::EvalTraceV1>,

    /// Timestamp when trace was created
    pub timestamp_us: u64,
}

/// Result and metric contracts are shared from flowtrace-core
