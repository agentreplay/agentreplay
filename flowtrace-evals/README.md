...
```rust
use flowtrace_evals::{EvaluatorRegistry, evaluators::*};
use std::sync::Arc;
...
```toml
[dependencies]
flowtrace-evals = { path = "../flowtrace-evals" }
...
```rust
use flowtrace_evals::evaluators::LatencyBenchmark;
...
```rust
use flowtrace_evals::evaluators::CostAnalyzer;
...
### Caching
```rust
use flowtrace_evals::EvalConfig;
...
Built by the Flowtrace team as part of the Flowtrace agent observability platform.
